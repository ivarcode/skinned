...
<head>
	...
	<script type="text/javascript">
		...
		/*DATA*/
		var GAME_STATS = {_SPEED:30,_CLOCK:null,_TOTAL_GAME_TIME_PAUSED:0,_PAUSE_CLOCK:null,_PAUSED:false/*game currently in dev so this var can change based on whether i want the game to start right away or wait for me to press 'p'*/};
		...
		function generate_necessary_chunks() {
